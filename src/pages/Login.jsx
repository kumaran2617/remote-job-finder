...
export default function Login(){
  ...
  return (
    <main style={{padding:'2rem',maxWidth:'500px',margin:'4rem auto',textAlign:'center'}}>
      ...
      <p style={{marginTop:'1rem',color:'#666'}}>
        Don't have an account? <a href="/register" style={{color:'#0ea5a4',textDecoration:'none'}}>Create one</a>
      </p>
    </main>
  )
}
