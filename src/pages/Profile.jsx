    ...
    <main className="page">
      ...
      <section className="profile-card">
        <div style={{display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '2rem'}}>
          <div style={{width: '80px', height: '80px', borderRadius: '50%', background: 'linear-gradient(135deg,#667eea 0%,#764ba2 100%)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#fff', fontSize: '2rem', fontWeight: 'bold'}}>
        ...
        <div style={{display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(150px, 1fr))', gap: '1rem', marginBottom: '2rem'}}>
          <div style={{background: 'linear-gradient(135deg,#667eea15 0%,#764ba215 100%)', padding: '1rem', borderRadius: '12px', textAlign: 'center', border: '1px solid #667eea30'}}>
          ...
          <div style={{background: 'linear-gradient(135deg,#764ba215 0%,#6366f115 100%)', padding: '1rem', borderRadius: '12px', textAlign: 'center', border: '1px solid #764ba230'}}>
